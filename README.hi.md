...
**बेवकूफ फ़ॉन्ट्स**एक प्रोजेक्ट है जो डेवलपर लक्षित फोंट को उच्च संख्या में ग्लिफ़ (आइकन) के साथ पैच करता है। विशेष रूप से लोकप्रिय 'प्रतिष्ठित फ़ॉन्ट्स' जैसे कि . से अधिक संख्या में अतिरिक्त ग्लिफ़ जोड़ने के लिए[फ़ॉन्ट विस्मयकारी][font-awesome],[डेविकॉन्स][vorillaz-devicons],[अष्टक][octicons], तथा[अन्य](#glyph-sets).
...
-   `master`शाखा फ़ाइल पथ हैं**नहीं**स्थिर माना जाता है।[अपने भंडार URI संदर्भों को सत्यापित करें](#unstable-file-paths)
-   इस भंडार की क्लोनिंग है**नहीं**अनुशंसित ([रेपो आकार के कारण](#option-5-clone-the-repo)) जब तक आप होने जा रहे हैं[विकास में योगदान](#contributing)
...
-   [**2 - रिलीज आर्काइव डाउनलोड**](#option-2-release-archive-download)
...
-   `Option 1.`चाहना**जल्दी जल्दी**एक को पकड़ो**व्यक्तिगत फ़ॉन्ट**से डाउनलोड करें[`patched-fonts/`निर्देशिका](#patched-fonts)
-   `Option 2.`डाउनलोड करना चाहते हैं**फ़ॉन्ट परिवार**विविधताओं का पैकेज (बोल्ड, इटैलिक, आदि) देखें[एक संग्रह डाउनलोड करें](#option-2-release-archive-download)
-   `Option 3.`चाहना**स्वचालित**में स्थापित करना या उपयोग करना**स्क्रिप्ट**देखें[स्क्रिप्ट स्थापित करें](#option-3-install-script)
-   `Option 4.`में हैं**मैक ओएस**और उपयोग करना चाहते हैं**होमब्रू**देख[Homebrew फ़ॉन्ट्स](#option-4-homebrew-fonts)
-   `Option 5.`चाहते हैं**पूर्ण नियंत्रण**फिर देखें[रेपो की क्लोनिंग](#option-5-clone-the-repo)
-   `Option 6.`का उपयोग करना चाहते हैं**`curl`आदेश**या में उपयोग करें**स्क्रिप्ट**देख[तदर्थ कर्ल डाउनलोड](#option-6-ad-hoc-curl-download)
-   `Option 7.`में हैं**आर्क लिनक्स**और उपयोग करना चाहते हैं**और पैकाग्रेस**देख[अनौपचारिक आर्क उपयोगकर्ता भंडार](#option-7-unofficial-arch-user-repository-aur)
-   `Option 8.`अपना खुद का फॉन्ट पैच करना चाहते हैं देखें[फ़ॉन्ट पैचर](#option-8-patch-your-own-font)
...
| [देजाव का व्यक्ति rd फोन को महत्व देता है t][p-dejavu]   |                                       | नहीं     | 2048     | ![w]![m2]![l]    |
...
> के लिए विकल्प**आर्क लिनक्स**और उपयोग करना चाहते हैं**और पैकाग्रेस**.

निम्नलिखित फोंट के माध्यम से उपलब्ध हैं[और पैकाग्रेस](https://aur.archlinux.org/)आर्क लिनक्स पर:
...
-   डॉकर का उपयोग कर वैकल्पिक विधि:[डॉकर हब](https://hub.docker.com/r/nerdfonts/patcher)
...
:चेतावनी: चेतावनी: रिलीज के आधार पर फ़ाइल पथ बदल सकते हैं (विशेषकर**प्रमुख**संस्करण धक्कों)

संदर्भ**रिहाई**शाखा और_नहीं_NS~~गुरुजी~~शाखा क्योंकि पथ प्रत्येक रिलीज के लिए परिवर्तन के अधीन हैं

-   उदाहरण के लिए:
    -   :white_check_mark: उपयोग करें:<code>https\\://github.com/ryanoasis/nerd-fonts/blob/<b>0.9.0</b>/पचेड़-फोंट्स/हर्मिट/मध्यम/कम्पलीट/हर्मिट%20मेडियम%20नेर्ड%20फॉण्ट%20कम्प्लेटे.ोटफ</code>
    -   :x: के बजाय:<code>https\\://github.com/ryanoasis/nerd-fonts/blob/<del>गुरुजी</del>/पचेड़-फोंट्स/हर्मिट/मध्यम/कम्पलीट/हर्मिट%20मेडियम%20नेर्ड%20फॉण्ट%20कम्प्लेटे.ोटफ</code>
